    ...
    async def charge_card(card_data: dict, user_data: dict, proxies: dict = None) -> tuple[str, str, bool]:
        ...
        async with AsyncSession(impersonate="chrome124", proxies=proxies) as session:
            try:
                ...
                print("Step 1: GET /donation/7255 ...")
                ...
                print("  - ap, lo, hash, pre, give extracted.")
                ...
                print("  - instanceId and sessionId obtained.")
                ...
                print("Step 4: Proof of work completed.")
                ...
                # تحويل السنة إلى 4 أرقام (مثل "26" -> 2026)
                yy_str = card_data["yy"]
                if len(yy_str) == 2:
                    exp_year = int("20" + yy_str)
                else:
                    exp_year = int(yy_str)
                ...
                json_nonce = {
                    ...
                    "card_data": {
                        ...
                        "exp_year": exp_year,   # <-- تم التصحيح
                        "number": card_data["cc"],
                    },
                    "pow_counter": var,
                }
                print("Step 5: POST /v2/card-nonce ...")
                ...
                print("Step 6: POST final donation ...")
...
# دالة اختبار (main)
async def main():
    # استخدم بطاقة اختبارية (غير حقيقية) لتجربة التسلسل
    test_card = "4211566115568609|12|26|123"
    print(f"Testing with card: {test_card}")
    result = await process_SQ_1_charge(test_card)
    print(f"\nFinal result: {result}")
